...
$( document ).ready(function() {
    ...
    // Enable links here
    const home_links = [about_home_link, tech_home_link, portfolio_home_link, awards_home_link, contact_home_link, menu_home_link, p1_home_link, p2_home_link];
    const all_pages_2 = [landing_page, about_page, tech_stack_page, portfolio_page, awards_page, contact_page, menu_page, p1_page, p2_page];
